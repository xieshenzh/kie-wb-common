...
public abstract class BaseEmbeddedSubprocess extends BaseSubprocess {

    public BaseEmbeddedSubprocess(BPMNGeneralSet general,
    ...
    public abstract EmbeddedSubprocessExecutionSet getExecutionSet();

    public abstract void setExecutionSet(EmbeddedSubprocessExecutionSet executionSet);
