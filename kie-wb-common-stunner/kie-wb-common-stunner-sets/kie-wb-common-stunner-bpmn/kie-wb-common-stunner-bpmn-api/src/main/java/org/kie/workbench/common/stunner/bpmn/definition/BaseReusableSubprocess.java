...
public abstract class BaseReusableSubprocess extends BaseNonContainerSubprocess {
    ...
    public abstract ReusableSubprocessTaskExecutionSet getExecutionSet();

    public abstract void setExecutionSet(ReusableSubprocessTaskExecutionSet executionSet);
}
