...
public class CaseManagementDrawCommand extends AbstractCanvasCommand {
    ...
    private boolean isDrawable(final Node<View, Edge> parent, final Node<View, Edge> child) {
    ...
    @SuppressWarnings("unchecked")
    private void sortNodes(final Diagram<Graph<DefinitionSet, Node>, Metadata> diagram) {
